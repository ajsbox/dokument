  <div class="row-fluid" style=" background-color:white!important;">
	...
	<div class="span10" style=" background-color:white!important;">
		...
		if(!empty($error)) {
		   ...
		   <form class="form-horizontal uni" action="<?php echo $this->logik->setting('default_url'); ?>external_users/add_user_in" method="post"  enctype="multipart/form-data" name="frm1" onSubmit="return validateUser()">
                    <div class="control-group">
                        <div class="controls">
                            <label><h6><?=$this->lang->line("Name");?></h6></label>
                            <input type="text" name="name" id="name" value="<?=$_POST['name']?>"  class="password"><br>
                     ...
                     <div class="control-group">
                        <div class="controls">
                            ...
                            <input type="text" name="email" value="<?=$_POST['email']?>" id="email"  class="password"><br>
                    ...
                    <div id="error_valid_email" style="display:none;color:#FF0000;"><strong>Error ! </strong><?=$this->lang->line("user_valid_email");?></div>
                     ...
                     <div class="control-group">
                        ...
                        <textarea name="description" id="description"  class="password"></textarea>             
