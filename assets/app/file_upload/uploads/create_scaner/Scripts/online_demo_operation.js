...
function acquireImage() {
    ...
    DWObject.Resolution = document.getElementById("Resolution").value;//here is where you set DPI
...
function btnUpload_onclick() {
    ...
    var OnSuccess = function(httpResponse) {
        appendMessage('<b>Carga: </b>');
        checkErrorStringWithErrorCode(0, "Exitosa.");
...
function Dynamsoft_OnImageAreaSelected(index, left, top, right, bottom) {
    ...
    _iRight = right;
    _iBottom = bottom;
	DWObject.MouseShape = false;  //ALFONSO
}
