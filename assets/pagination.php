...
class pagination {
	...
	private $activeclass			=	'activeLPNN';
	...
	public function render() {
		...
		if($this->jumpers	===	true && $this->currentpage != 1) { 
			echo '<span><a href="'.$this->render_text($this->link_url,1).'" title="'.$this->render_text($this->jumper_first_title,1).'">'.$this->render_text($this->jumper_first_text,1).'</a></span>' . PHP_EOL;
		}
		
		if($this->steps	===	true && $this->currentpage > 1) {
			echo '<span><a href="'.$this->render_text($this->link_url,($this->currentpage-1)).'" title="'.$this->render_text($this->steps_back_title,($this->currentpage-1)).'">'.$this->render_text($this->steps_back_text,($this->currentpage-1)).'</a></span>' . PHP_EOL;
		}
		...
		if($this->jumpers	===	true && $this->currentpage != $this->totalpages ) {
			echo '<span><a href="'.$this->render_text($this->link_url,$this->totalpages).'" title="'.$this->render_text($this->jumper_last_title,$this->totalpages).'">'.$this->render_text($this->jumper_last_text,$this->totalpages).'</a></span>' . PHP_EOL;
		}
